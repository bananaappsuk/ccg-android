 ...
 */
public class EventApply extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.event_board, container, false);
        // Inflate the layout for this fragment
        Cache.putData(CatchValue.BackArrow, getContext(), "EventApply", Cache.CACHE_LOCATION_DISK);
    ...
    login.setText("Register");
        ...
        register_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog.setContentView(R.layout.alert_description_apply);
              ...
              public void onClick(View v) {
                  ...
                  if (isInternetPresent) {
                   ...
                   //   Log.e("11111 Traning_Id "," "+((String) Cache.getData(CatchValue.ID,getContext())));
                      dialog.dismiss();
                      new RegisterTask().execute(Traning_Id, ((String) Cache.getData(CatchValue.ID,getContext())),""+1);
                  } else {
