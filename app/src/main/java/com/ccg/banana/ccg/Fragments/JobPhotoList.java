...
public class JobPhotoList implements Parcelable {
    ...
    protected JobPhotoList(Parcel in) {
        ID = in.readString();
        Traning_Id = in.readString();
        Traning_Photo = in.readString();
    }

    protected JobPhotoList(String ID,String Traning_Id,String Traning_Photo) {
        this.ID=ID;
    ...
    public static final Creator<JobPhotoList> CREATOR = new Creator<JobPhotoList>() {
        @Override
        public JobPhotoList createFromParcel(Parcel in) {
            return new JobPhotoList(in);
        }

        @Override
        public JobPhotoList[] newArray(int size) {
            return new JobPhotoList[size];
        }
    };
