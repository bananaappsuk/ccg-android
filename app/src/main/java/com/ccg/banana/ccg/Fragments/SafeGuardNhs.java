 ...
 */
public class SafeGuardNhs extends Fragment {
...
TextView msgBoardTxt;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.safe_guard_nhs, container, false);
        ...
        Cache.putData(CatchValue.BackArrow, getContext(), "SafeGauardNhs", Cache.CACHE_LOCATION_DISK);
     ...
     //   mywebview.loadUrl("http://www.myguideapps.com/nhs_safeguarding/default/safeguarding_adults/?nocache=0.4674478393244097");
        ...
        safeGuarding.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Cache.putData(CatchValue.Safe, getContext(), "safe", Cache.CACHE_LOCATION_DISK);
        ...
        childProtection.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Cache.putData(CatchValue.Safe, getContext(), "childProtection", Cache.CACHE_LOCATION_DISK);
                FragmentTransaction transaction = getActivity().getSupportFragmentManager().beginTransaction();
                transaction.replace(R.id.content, new SafeGuardNhsAdult());
                transaction.commit();
            }
